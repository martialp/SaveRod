...
import me.qintinator.saverod.eventlisteners.OnEntityDeathEvent;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Bukkit.getPluginManager().registerEvents(new OnEntityDeathEvent(Bootstrapper.getSaverodService()), this);
    }
}
